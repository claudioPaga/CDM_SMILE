...
trap_species_image_density = [0.166,0.166] ; EOL Densities derived from PL fit of CCD370_Meanfit.txt (email 6 Oct 2020)
trap_species_store_density = [0.166,0.166]
trap_species_serial_density = [0.033,0.033]
...
capture_cross_section_image = [0.005,0.005] ; This values corresponds to a Pc = 0.9 at Fe55, Pc = 0.3 @ 0.6 keV
