...
;Convergence threshold of iterative CTI correction algorithm
iter_th = 1
...
trap_species_image_density = [0.005,0.005] ; Density derived from PL fit of CCD370_Meanfit.txt (email 6 Oct 2020)
trap_species_store_density = [0.005,0.005]
trap_species_serial_density = [0.005,0.005]
...
capture_cross_section_image = [1.0e+3,1.0e+3] ; Set cross section to high value, corresponding to Pcapture=1 (immediate capture) to simplify treatment
capture_cross_section_store = [1.0e+3,1.0e+3]
capture_cross_section_serial = [1.0e+3,1.0e+3]
charge_volume_coeff_image  = 0.75 ; Beta derived from PL fit of CCD370_Meanfit.txt (email 6 Oct 2020)
charge_volume_coeff_store  = 0.75
charge_volume_coeff_serial  = 0.75
flag_split = 1
flag_unbinned = 0
