function cdm_process_store, flux_input, readout_time, trap_density, decay_index, capture_cross_section, charge_volume_coeff,  flag_retrapping = flag_retrapping, flag_iteration = flag_iteration, iter_max = iter_max, threshold = threshold, short_bernoulli = short_bernoulli, long_bernoulli = long_bernoulli
...
;
; - 9 Sept 2020
;   Minor updated for use with SMILE
...
;trap specie
   ...
   if flux_input[ac_counter] gt 0. then begin
      ...
      if keyword_set(flag_iteration) then losses_pixel_array =  capture_serial_java_betavol_iterate_v0(flux_input[ac_counter], ac_counter+1, trap_density_free_array, capture_cross_section, readout_time, charge_volume_coeff, total_release_following_pixel_array,  flag_retrapping = flag_retrapping, iter_max = iter_max, threshold = threshold, short_bernoulli = short_bernoulli,long_bernoulli = long_bernoulli) $
      else losses_pixel_array =  capture_serial_java_betavol_v0(flux_input[ac_counter], ac_counter+1, trap_density_free_array, capture_cross_section, readout_time, charge_volume_coeff, total_release_following_pixel_array, flag_retrapping = flag_retrapping, short_bernoulli = short_bernoulli, long_bernoulli = long_bernoulli)
